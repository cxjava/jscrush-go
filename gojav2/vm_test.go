...
func TestJscrush(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Jscrush(tt.args.js); len(got) != tt.want {
				fmt.Println(len(got))
